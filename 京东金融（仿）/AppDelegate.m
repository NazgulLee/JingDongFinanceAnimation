...
//	[rootViewController.navigationBar setBackgroundImage:[[UIImage alloc] init] forBarMetrics:UIBarMetricsDefault];//和下面一起才能去掉navigationBar的边界
//	[rootViewController.navigationBar setShadowImage:[[UIImage alloc] init]];
